@echo off
echo ===================================================
echo Installation du Scheduler Laravel (DEV WINDOWS)
echo ===================================================
echo.
...
echo NB : adapter d'abord les chemins absolus dans laravel-scheduler-task.xml
echo      (Task Scheduler ne supporte pas les chemins relatifs dans le XML).
