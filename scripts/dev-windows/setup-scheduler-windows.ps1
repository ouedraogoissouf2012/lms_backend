# Script PowerShell pour configurer le scheduler Laravel sur Windows (DEV UNIQUEMENT)
# Exécuter en tant qu'administrateur
# Le chemin du .bat est déduit de l'emplacement de ce script — aucun chemin à adapter.

Write-Host "=== Configuration du Scheduler Laravel pour Windows ===" -ForegroundColor Cyan
Write-Host ""

$taskName = "Laravel_LMS_Scheduler"
$scriptPath = Join-Path $PSScriptRoot "scheduler.bat"
