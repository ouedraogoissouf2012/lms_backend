...
final class AsyncReportStore
{
     ...
     */
    public function pending(string $id, int $userId, string $type, array $meta = []): void
    {
        $this->put($id, [
            'id' => $id,
            'user_id' => $userId,
    ...
    public function completed(string $id, string $path, string $filename): void
    {
        $this->patch($id, [
            'status' => 'completed',
            'path' => $path,
