...
class EvaluationCoordinatorRestrictionsTest extends TestCase
{
    ...
    public function test_coordinateur_cannot_create_evaluation()
    {
        ...
        $response->assertJson([
            ...
            'message' => 'Les coordinateurs ne peuvent pas créer d\'évaluations.'
        ]);
    ...
    public function test_coordinateur_cannot_update_evaluation()
    {
        ...
        $response->assertJson([
            'success' => false,
            'error_code' => 'PERMISSION_DENIED',
            'message' => 'Les coordinateurs ne peuvent pas modifier d\'évaluations.'
        ]);
    ...
    public function test_coordinateur_cannot_delete_evaluation()
    {
        ...
        $response->assertJson([
            'success' => false,
            'error_code' => 'PERMISSION_DENIED',
            'message' => 'Les coordinateurs ne peuvent pas supprimer d\'évaluations.'
        ]);
